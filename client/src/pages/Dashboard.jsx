        ...
        <div className="bg-background text-on-surface font-body cyber-grid min-h-screen text-left">
            ...
            <main className="p-6 md:p-10">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
                    ...
                    <div className="flex flex-wrap gap-4 items-center">
                        <button 
                            ...
                            className="bg-error/10 border border-error/20 text-error font-label px-6 py-2.5 rounded-full hover:bg-error/20 transition-all flex items-center gap-2 text-xs font-black uppercase tracking-widest active:scale-95"
                        >
                            <span className="material-symbols-outlined text-sm">logout</span> Logout
                        </button>
                        <button 
                            onClick={handleExport}
                            className="bg-gradient-to-r from-primary to-primary-container text-on-primary font-headline font-bold px-10 py-2.5 rounded-full shadow-[0_0_20px_rgba(0,238,252,0.3)] hover:scale-105 active:scale-95 transition-all text-xs uppercase tracking-[0.2em] flex items-center gap-3"
                        >
                            <span className="material-symbols-outlined text-sm">assessment</span> Export Master Report (.xlsx)
                        </button>
                    </div>
                </header>
                ...
                <section className="grid grid-cols-12 gap-6 mb-12">
                    {/* Total Registrations */}
                    <div className="col-span-12 md:col-span-6 glass-card p-8 rounded-2xl flex flex-col justify-between border border-white/5 border-t-2 border-t-primary/30">
                    ...
                    {/* Revenue */}
                    <div className="col-span-12 md:col-span-6 glass-card p-8 rounded-2xl border border-white/5 border-t-2 border-t-secondary/30 text-left">
                        <div className="text-left">
                            ...
                            <table className="w-full text-left font-body">
                                <thead className="bg-surface-container-low text-[10px] font-label uppercase tracking-widest text-on-surface-variant font-black">
                                    <tr>
                                        ...
                                        <th className="px-8 py-4">Team Size</th>
                                        <th className="px-8 py-4 text-right">Leader Mobile</th>
                                    ...
                                    {registrations.length === 0 ? (
                                        ...
                                        registrations.map((team, idx) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-8 py-5">
                                                    <span className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant opacity-60 font-mono">{team.teamSize} Members</span>
                                                </td>
                                                <td className="px-8 py-5 text-right">
                                                    <span className="text-sm font-bold text-primary font-mono">{team.leaderPhone}</span>
                                                </td>
                                                <td className="px-8 py-5 text-right">
                                                    <button className="material-symbols-outlined text-on-surface-variant hover:text-on-surface transition-colors">visibility</button>
                                                </td>
                                            </tr>
                                        ))
                                    )}
